...
var TouchDragButton = function TouchDragButton(_ref) {
  ...
  var _useState = (0, _react.useState)(""),
      ...
      offLeft = _useState2[0],
      setOffLeft = _useState2[1];
  // 上偏移量
  ...
  var _useState3 = (0, _react.useState)(""),
      ...
      offTop = _useState4[0],
      setOffTop = _useState4[1];

  // 监听


  (0, _react.useEffect)(function () {
    $dragRef.current.addEventListener("touchmove", function (e) {
      if (e.cancelable) {
        e.preventDefault();
      }
    }, { passive: false });
  ...
  var _onTouchStart = function _onTouchStart(e) {
    ...
    // 计算偏移量
    var oLeft = e.clientX - _variables['oW'];
    var oTop = e.clientY - _variables['oH'];
    setOffLeft(oLeft);
    setOffTop(oTop);
  ...
  // 移动中
  var _onMove = function _onMove(e) {
    e = e.touches[0];
  ...
  return _react2.default.createElement(
    ...
    {
      ref: $dragRef,
      className: (0, _classnames2.default)("drag_button", className),
...
exports.default = TouchDragButton;
...
// module
exports.push([module.i, ".drag_button {\r\n    position: fixed;\r\n    right: 0;\r\n    bottom: 75px;\r\n    width: 56px;\r\n    height: 56px;\r\n    z-index: 1000;\r\n}\r\n\r\n.drag_button__animate {\r\n    transition-duration: .4s;\r\n}\r\n", ""]);
